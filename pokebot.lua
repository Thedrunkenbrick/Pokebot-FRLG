...
function getTrainer()
	...
	--Setting the correct offset depending on game version
	...
	trainer = { -- # TODO add items in bag
		...
		state = Memory.readbyte(GameSettings.trainerpointer + stateOffSet), -- TODO Test this on RS and FRLG
		mapId = Memory.readbyte(GameSettings.trainerpointer + 200), -- TODO Test this on RS and FRLG
		mapBank = Memory.readbyte(GameSettings.mapbank), -- TODO Test this on RS and FRLG
