...
from modules.gen3.Legendaries import ModeLegendary, ModeGroudon, ModeKyogre, ModeRayquaza, ModeMew, ModeRegis, ModeSouthernIsland, \
...
def MainLoop():
    ...
    log.info("Detected game: " + GetEmu()["detectedGame"])
    ReleaseAllInputs()
